...
function buildMenu() {
    ...
    $('#view-ad').addEventListener('click', function(e) {
        var win = window.open('https://view.ionic.io/', '_blank');
        win.focus();
    });
...
function buildComponentsMenu() {
    var items = [
        {
            href: 'https://ionicframework.com/docs/components/#overview',
            title: 'Overview'
        },
        {
            href: 'https://ionicframework.com/docs/components/#action-sheets',
            title: 'Action Sheets'
        },
        {
            href: 'https://ionicframework.com/docs/components/#alert',
            title: 'Alerts'
        },
        {
            href: 'https://ionicframework.com/docs/components/#badges',
            title: 'Badges'
        },
        {
            href: 'https://ionicframework.com/docs/components/#buttons',
            title: 'Buttons'
        },
        {
            href: 'https://ionicframework.com/docs/components/#cards',
            title: 'Cards'
        },
        {
            href: 'https://ionicframework.com/docs/components/#checkbox',
            title: 'Checkbox'
        },
        {
            href: 'https://ionicframework.com/docs/components/#datetime',
            title: 'DateTime'
        },
        {
            href: 'https://ionicframework.com/docs/components/#fabs',
            title: 'FABs'
        },
        {
            href: 'https://ionicframework.com/docs/components/#gestures',
            title: 'Gestures'
        },
        {
            href: 'https://ionicframework.com/docs/components/#grid',
            title: 'Grid'
        },
        {
            href: 'https://ionicframework.com/docs/components/#icons',
            title: 'Icons'
        },
        {
            href: 'https://ionicframework.com/docs/components/#inputs',
            title: 'Inputs'
        },
        {
            href: 'https://ionicframework.com/docs/components/#lists',
            title: 'Lists'
        },
        {
            href: 'https://ionicframework.com/docs/components/#loading',
            title: 'Loading'
        },
        {
            href: 'https://ionicframework.com/docs/components/#menus',
            title: 'Menus'
        },
        {
            href: 'https://ionicframework.com/docs/components/#modals',
            title: 'Modals'
        },
        {
            href: 'https://ionicframework.com/docs/components/#navigation',
            title: 'Navigation'
        },
        {
            href: 'https://ionicframework.com/docs/components/#popovers',
            title: 'Popover'
        },
        {
            href: 'https://ionicframework.com/docs/components/#radio',
            title: 'Radio'
        },
        {
            href: 'https://ionicframework.com/docs/components/#range',
            title: 'Range'
        },
        {
            href: 'https://ionicframework.com/docs/components/#searchbar',
            title: 'Searchbar'
        },
        {
            href: 'https://ionicframework.com/docs/components/#segment',
            title: 'Segment'
        },
        {
            href: 'https://ionicframework.com/docs/components/#select',
            title: 'Select'
        },
        {
            href: 'https://ionicframework.com/docs/components/#slides',
            title: 'Slides'
        },
        {
            href: 'https://ionicframework.com/docs/components/#tabs',
            title: 'Tabs'
        },
        {
            href: 'https://ionicframework.com/docs/components/#toast',
            title: 'Toast'
        },
        {
            href: 'https://ionicframework.com/docs/components/#toggle',
            title: 'Toggle'
        },
        {
            href: 'https://ionicframework.com/docs/components/#toolbar',
            title: 'Toolbar'
        }
    ];
